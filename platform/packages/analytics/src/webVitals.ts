// Core Web Vitals forwarded to PostHog as "web_vital" events.
// Lifted from codecast packages/web/lib/reportWebVitals.ts. Needs the
// web-vitals peer dependency, so it lives on its own subpath.

import { onCLS, onFCP, onINP, onLCP, onTTFB, type Metric } from "web-vitals";
import { track } from "./web";
