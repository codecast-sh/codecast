...
export type OrgInitSummary = {
   ...
   *  predates the block. */
  coverage?: { initiatives_active: number; initiatives_without_owner: number; with_work: number; with_lead: number; outside_plans: number; outside_areas: number; outside_repositories: number };
};
