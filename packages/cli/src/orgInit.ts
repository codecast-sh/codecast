...
export const ORG_CONVERSATION_RULES = {
  ...
  evidence_behind: "Knowledge stays behind the words. Hold the evidence for everything you say, and give it when asked. A message says what is so, never what you read, checked or did to find it out; it never cites an id, never talks about you, and never names the thread it is written in.",
