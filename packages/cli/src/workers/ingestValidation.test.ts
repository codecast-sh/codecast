...
const result = () => ({messages:[{role:'assistant',content:'hello',timestamp:1}],bytesConsumed:100,fileSize:100,totalCount:1,maxRowId:0,signatures:['a'.repeat(64)],messageTitles:[null],handoffParents:[null],metadata:{warnings:[]}});
