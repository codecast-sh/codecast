...
try {
  ...
  console.log(JSON.stringify({enabled,production:true,formats:8,parentParses,workerPid:pid,serialized:true,positions:true,queued:true,fallbackParses,adversarial:adversarialReceipt}));
