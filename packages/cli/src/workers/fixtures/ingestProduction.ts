...
if (['mutant','custody-mutant','custody','retry-mutant','ack','ack-mutant','ack-restart','registration','task-review','scheduled-review','custody-review','disappearance-review','emission-review','sub-batch-review'].includes(process.argv[3])) {
