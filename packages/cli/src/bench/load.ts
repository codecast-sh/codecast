...
export interface LoadResult {
  ...
  churn: { durationMs: number; intervalMs: number; linesAppended: number; startedAt: number | null; endedAt: number | null; expectedRounds: number; missedRounds: number; rounds: { scheduledAt: number; startedAt: number; finishedAt: number; lines: number }[] };
