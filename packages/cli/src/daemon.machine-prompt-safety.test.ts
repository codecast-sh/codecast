...
function fixture(transport = "tmux", cached = true) {
  ...
  const names = [
    ...
    "tmuxWatchablePrefix", "awaitTmuxComposerPayload", "normalizePromptText", "tmuxPromptStillHasInput", "tmuxPromptShowsPastePlaceholder",
  ...
  const constants = [
    "RESUME_CWD_PICKER_RE", "DRAIN_MAX_CYCLES", "stripComposerWs", "TMUX_ONLY_TERMINALS", "DELIVERY_TIMEOUT_MS", "TRUST_PROMPT_RE",
