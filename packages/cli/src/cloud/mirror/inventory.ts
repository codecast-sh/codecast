...
import {
  ...
  activeContextReferences, contextReferences, isAccessError, isAccountDataPath, isDefaultExcluded, isDeniedPath, isNativeBinary, isReferencedDirectory, matchesContextPattern,
} from "./discovery.js";
