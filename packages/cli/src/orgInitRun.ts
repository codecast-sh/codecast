...
function changeKindsReference(): string {
  return [
    ...
    `- initiative: { title, description, projects: [ref], owner?: "@handle" | "me" | a member's name, target_date?: unix ms }. Set a goal the company has not written down: its name, one sentence that says what reaching it looks like, the projects whose work carries it, and who drives it when the evidence shows who. Accepting creates it on the initiatives page as proposed.`,
