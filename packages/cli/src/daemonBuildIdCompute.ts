...
/** The shape of the stamp line, and the shape of the id on its own. Both live
 *  in the generated file so the stamp script, the daemon's disk read and the
 *  CLI's `_build-id` read cannot drift apart. */
export { BUILD_ID_RE, BUILD_ID_VALUE_RE } from "./daemonBuildId.js";
...
export const BUILD_ID_VALUE_RE = /^[0-9a-f]{${ID_CHARS}}$/;
