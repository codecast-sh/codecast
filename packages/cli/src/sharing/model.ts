...
import { planSyncChange as planWith, type SyncChange, type SyncPlan, type SyncSettings } from "@codecast/shared/team/syncPlan";
import { isProjectAllowedToSync } from "../syncScope.js";
import type { Config } from "../config/types.js";

export type { SyncChange, SyncPlan, SyncSettings };
...
/** The shared plan (settings page and CLI alike), with the daemon's own
 *  scope rule, which also counts a worktree as its checkout. */
export function planSyncChange(settings: SyncSettings, change: SyncChange): SyncPlan {
  return planWith(settings, change, isSyncing);
}
