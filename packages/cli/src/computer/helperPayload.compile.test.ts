...
// The build owns this path (`COMPUTER_HELPER_PAYLOAD` in build-with-native.ts).
// Naming it again here keeps `scripts/` out of the CLI's typechecked source, and
// the two cannot drift silently: a wrong path here leaves the payload empty and
