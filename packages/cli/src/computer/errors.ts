...
const RECOVERY: Record<ComputerErrorCode, string[]> = {
  ...
  permission_denied: [
    "Run `cast computer permissions`, grant Accessibility to codecast computer in System Settings, then retry.",
  ...
  screenshot_failed: [
    ...
    "If the message names Screen Recording, run `cast computer permissions --id screenshots` and grant it.",
  ],
  accessibility_error: [
    "Run `cast computer capabilities`.",
    "If the message names Accessibility, run `cast computer permissions --id accessibility`.",
