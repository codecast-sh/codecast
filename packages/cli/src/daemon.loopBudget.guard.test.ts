...
const ROWS: Row[] = [
  ...
  { file: D, name: "module setInterval", kind: "intervals", from: "", to: MAIN, minLines: 3, mustContain: "", minCount: 1 },
...
// The block name may itself contain a colon-free quoted string; split on the
// LAST three colons so `watcher.on("session")` survives.
