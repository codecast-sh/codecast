...
const ROWS: Row[] = [
  ...
  { file: D, name: "runHibernationPass", kind: "function", minLines: 30, mustContain: "selectHibernationCandidates" },
  { file: D, name: "sweepStaleTmuxServers", kind: "function", minLines: 10, mustContain: "findStaleTmuxServers" },
  // Nested in main().
