// ct-49753: the Enter gate must refuse a composer that already holds two copies.
//
...
import { awaitTmuxComposerPayload } from "./daemon.js";
...
describe.skipIf(!CAN_RUN)("the Enter gate refuses a claude composer holding two copies", () => {
  afterAll(() => {
