...
private func writePermissionStatus(to path: String) {
    ...
    do {
        // 0600, not the umask's 0644: this says what this Mac has granted and
        // it belongs to the user who asked for it (ct-49615).
        try PrivateFileWrite.write(text, to: path)
    } catch {
