...
/codecast-verify before closing it. Commit on the task's branch and open a pull
request with /codecast-ship; do not merge. Queue anything that needs a person with
