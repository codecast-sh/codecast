    ...
    <SettingsSection
      ...
      description={
        <>
          ...
          learns what your sessions are doing. Hooks you added yourself are never touched.
        </>
      }
    >
      <SettingsRow
          ...
          description={
            <>
              ...
              <span className="mt-1.5 block font-mono text-[11px] text-sol-text-dim">
                ~/.claude/hooks/{h.file}
                {h.events.length > 0 ? ` on ${h.events.join(", ")}` : h.kind === "statusLine" ? " as the statusLine command" : ""}
              </span>
            </>
          }
        >
