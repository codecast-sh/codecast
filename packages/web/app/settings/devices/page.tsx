...
// The loop-freeze SLO for one machine. Only shown once the daemon has reported
// a freeze; the wording comes from daemonHealthCopy so this and the header chip
// never drift.
