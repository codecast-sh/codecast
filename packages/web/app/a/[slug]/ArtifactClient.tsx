...
export default function ArtifactClient() {
  ...
  return (
    <main className="h-dvh w-full relative bg-white">
      ...
      {/* Floating share pill — deliberately quiet until hovered. */}
      <div className="fixed bottom-3 right-3 z-10 flex items-center gap-1 rounded-full border border-sol-border/50 bg-sol-base03/90 backdrop-blur px-2.5 py-1.5 shadow-lg opacity-70 hover:opacity-100 transition-opacity">
        <a
