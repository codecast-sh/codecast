...
import { parseDiffLineKey, type DiffLineAnchor } from "../../../../../../lib/patchParser";
import {
  breadcrumbTrail,
  extendLineRange,
  formatLineHash,
...
function BlobContent({
  ...
  const readHash = useCallback(() => setSelection(parseLineHash(window.location.hash)), []);
  useWatchEffect(readHash, [path]);
  useEventListener("hashchange", readHash);
