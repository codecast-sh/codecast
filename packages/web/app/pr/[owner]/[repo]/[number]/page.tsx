...
import { useSyncPRGitEvents, useGitEvents } from "../../../../../hooks/useSyncGitEvents";
...
function PRContent({
  ...
  useSyncPRGitEvents(prId);
  useSyncPRCodeComments(prId);
  const events = useGitEvents(useCallback((e: any) => e.pr_id === prId, [prId]));
