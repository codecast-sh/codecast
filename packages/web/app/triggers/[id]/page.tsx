            ...
            {t.precheck && (
              ...
              >
                ...
                <p className="mt-1 text-[10px] text-sol-text-dim">
                  Runs before each scheduled firing. Exit 0 runs the trigger; anything else
                  records a skipped run. Run now and cast trigger run bypass it.
                </p>
                {t.last_run_source === "manual" && (
                  <p className="mt-1 text-[10px] text-sol-text-dim">
                    The last run was manual, so it ran without the gate.
                  </p>
                )}
