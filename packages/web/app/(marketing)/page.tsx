      ...
      <nav className="backdrop-blur-sm sticky top-0 z-50" style={{ borderBottom: '1px solid #eee8d5', backgroundColor: 'rgba(253,246,227,0.8)' }}>
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/download" className="font-medium text-sm px-3 py-1.5 hidden sm:block transition-colors" style={{ color: '#657b83' }} onMouseEnter={e => (e.currentTarget.style.color = '#002b36')} onMouseLeave={e => (e.currentTarget.style.color = '#657b83')}>
              Download
            </Link>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <Link href="/download">
              <Button size="lg" variant="outline" className="bg-transparent text-base px-6 h-12 font-medium gap-2" style={{ borderColor: '#002b36', color: '#002b36' }}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
