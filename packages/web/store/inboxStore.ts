...
interface InboxStoreState extends ChatSliceState {
  ...
  // -- Saved views --
  createSavedView: (opts: { name: string; page: "tasks" | "docs" | "plans"; prefs: any; shared?: boolean; icon?: string; client_key?: string; team_id?: string }) => any;
  ...
  updateTask: (shortId: string, fields: { status?: string; priority?: string; title?: string; description?: string; labels?: string[]; triage_status?: string; assignee?: string; execution_status?: string; project_id?: string; project_path?: string; parent?: string; sort_order?: number; duplicate_of?: string; subtask_resolution?: "cascade" | "only_parent" }) => Promise<any>;
...
export const STAMPED_UI_KEYS = new Set([
  ...
  "simple_view", "inbox_image_thumbs", "composer_suggestions",
]);
