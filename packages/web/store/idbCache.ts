...
export const CACHE_SCHEMA_SIGNATURE =
  "bucketAssignments:_id|buckets:_id|capabilityBindings:_id|capabilityState:_id|chatChannels:_id|chatMessages:_id, channel_id, thread_root_id|chatReactions:_id, message_id|chatReads:_id, channel_id|comments:_id|docs:_id|plans:_id|projects:_id|sessionDecisions:_id|sessions:_id|tasks:_id";
