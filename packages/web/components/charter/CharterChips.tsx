...
export function OwnerRoleChip({ tree, ownerRoleId, onChange, onHire, blockedReason, size = "sm", className }: {
  ...
  const reason = blockedReason ?? (tree ? "No roles in this workspace yet: hire one on the org page" : "Roles are still loading");
  const onClick = () => {
