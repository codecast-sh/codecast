    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-wrap items-center justify-between gap-y-2 px-6 py-2 border-b border-sol-border/10 flex-shrink-0">
        ...
        <div className="flex items-center gap-1 ml-auto">
          ...
          {/* One chrome for the detail pane: pin/full plus the standard ✕.
              Closing here is a navigation, so the slot's default hide is
              overridden — the affordance stays identical either way. */}
          <PeekLayoutControls />
          <SlotChrome slot="primary" canPromote={false} onClose={() => router.push(backHref)} />
          {metaContent && (
            <button
