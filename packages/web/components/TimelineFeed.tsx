        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 text-xs text-sol-text-muted0 flex-wrap">
              ...
              {item.active_plan && (
                <Link href={`/plans/${item.active_plan._id}`} className="inline-block align-middle px-1.5 py-0.5 rounded text-[10px] bg-sol-cyan/10 text-sol-cyan border border-sol-cyan/20 hover:bg-sol-cyan/20 transition-colors max-w-[140px] truncate" onClick={(e) => e.stopPropagation()} title={item.active_plan.title}>
