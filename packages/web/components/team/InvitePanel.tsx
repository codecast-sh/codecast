    ...
    <div className={`tf-accent-scope ${page ? "space-y-6" : "space-y-4 py-4"}`}>
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <Label htmlFor="team-invite-link" className="text-sol-base1">Invite link</Label>
          <span className="flex items-center gap-2 text-xs">
            ...
            <span aria-live="polite" className={isExpired ? "text-sol-red" : "text-sol-base1"}>
        ...
        {regenError && (
          <p className="text-sm text-sol-red" aria-live="polite">
            Could not make a new link. The current one still works.
          </p>
        )}
        {isExpired && (
      ...
      <div className="pt-3 border-t border-sol-border space-y-2">
        <Label htmlFor="team-invite-email" className="text-sol-base1">Or email an invite</Label>
