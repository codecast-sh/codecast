  ...
  return (
    <div className="rounded-xl overflow-hidden" style={{ border: '1px solid #586e75' }}>
      ...
      <div className="p-4 flex items-center justify-between gap-4" style={{ backgroundColor: '#002b36' }}>
        ...
        <button
          onClick={handleCopy}
          className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-md text-sm font-semibold transition-colors shrink-0"
          style={copied
      ...
      <div className="px-4 pb-3 flex items-center justify-between gap-4 text-xs" style={{ backgroundColor: '#002b36', color: '#586e75' }}>
        <span>
          {platform === "windows"
        ...
        <a
          ...
          className="shrink-0 underline decoration-dotted underline-offset-2 transition-colors hover:text-[#93a1a1]"
        >
          view the script
        </a>
      </div>
