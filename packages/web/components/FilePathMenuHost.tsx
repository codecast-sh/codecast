...
// they hand the event to this host (requestFilePathMenu), mounted once in
// the dashboard shell next to the other docks.
...
import { filePathHref, type FilePathContextValue } from "../lib/filePathLinks";
...
export function FilePathMenuHost() {
  ...
  useEffect(() => {
    listener = (e, payload) => menu.open(e, payload, { force: true });
    return () => {
      listener = null;
    };
  }, [menu]);
