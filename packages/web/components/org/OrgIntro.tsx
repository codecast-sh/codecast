...
export const ORG_INTRO_LINES: readonly OrgIntroLine[] = [
  { face: "fox", text: "Your organization has roles: agents that each keep watching one area of work, with a face, a boss, sessions that report to them and tasks they own." },
  ...
  { face: "bear", text: "A role triages its own sessions and puts in front of you only what needs you, with one line saying why." },
  { face: "hare", text: "You can talk to any role from its page, and hover any role anywhere to see what it looks after." },
  { face: "crane", text: "All of this works from any session too: ask for /org." },
];
...
export function OrgIntro({ hasRoles, compact = false, onStart, onLater, lines = ORG_INTRO_LINES }: {
