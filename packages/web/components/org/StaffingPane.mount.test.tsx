...
async function verifyStaffingPane() {
  ...
  // ── a link into another workspace: the line, never the fixture ──
  await render({ proposal: null, selectedChangeId: null, proposals: [], link: { kind: "foreign", shortId: "op-4", workspaceName: "Codecast", onSwitch: () => calls.push("switch") } });
  ...
  await render({ proposal: null, selectedChangeId: null, proposals: [], link: { kind: "unreadable", shortId: "op-99" } });
