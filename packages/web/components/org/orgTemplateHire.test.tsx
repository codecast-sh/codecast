...
import { buildOrgTemplateCommand } from "./orgTemplateHire";
...
describe("org template command handoff", () => {
  ...
  test("mounted hire flow preserves manual drafts and never creates a template role directly", () => {
    const child = Bun.spawnSync(["bun", "run", new URL("./orgTemplateHire.mount.test.tsx", import.meta.url).pathname], { cwd: new URL("../../", import.meta.url).pathname, timeout: 30_000 });
