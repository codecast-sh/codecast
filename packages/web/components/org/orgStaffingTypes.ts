...
export type OrgCompanyHealth = {
  ...
  /** Several roles list the project and it names none as its lead (R4); the
   *  handles of the roles that watch it. Absent from a server older than W7. */
  watched_without_lead?: { id: string; title: string; roles: string[] }[];
