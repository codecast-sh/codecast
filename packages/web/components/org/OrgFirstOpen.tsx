 ...
 *  from the toolbar) it names the Staffing pane, which holds them. */
export function orgGuideSteps(meNodeId: string | null, hasRoles: boolean): OrgGuideStep[] {
  return [
    {
      id: "you",
...
export function OrgEmptyCanvas({ me, reviewing, onHireChief, onProposeNow, bottom = 44 }: {
  me: OrgPerson | null;
...
export function OrgGuide({ steps, step, onStep, onDone }: {
  steps: OrgGuideStep[];
  step: number;
