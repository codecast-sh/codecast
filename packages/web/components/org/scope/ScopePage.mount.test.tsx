...
async function verifyScopePage() {
  ...
  mock.module("../../anchor/AnchorConversation", () => ({
    AnchorConversation: (props: any) => React.createElement("div", { "data-thread": props.conversationId, "data-thread-autofocus": props.autoFocusInput ? "1" : "0", "data-thread-owner": props.seedOwnership ? "1" : "0", "data-thread-fold": props.foldBootstrap ? "1" : "0", "data-thread-density": props.initialDensity ?? "" }, props.leadNode, React.createElement("textarea", { "data-composer": true })),
  ...
  assert.match(q("[data-scope-lead-state]")!.textContent!, /Rewriting the weekly growth review/, "and what it is watching");
  assert.match(q("[data-scope-lead-ask]")!.textContent!, /2 hands are waiting on a person/, "and what waits on the person");
