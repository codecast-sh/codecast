  ...
  roles: [
    {
      ...
      total: growth.length,
      standing: {
        conversation_id: "fixture-growth-conv",
        short_id: "jx7gr0w",
        state: "working",
        state_line: "Rewriting the weekly growth review",
        state_status: "working",
        state_at: T0 - 1_200_000,
      },
      scope_names: {
  ...
  anchors: [
    {
      ...
      state: "dormant",
      status: "active",
      state_line: "Watching the inbox; nothing needs the founder",
      state_status: "dormant",
      state_at: T0 - 2_700_000,
    },
  ],
  generated_at: T0,
};
