...
const DEFINITION: Record<GlossaryWord, string> = {
  ...
  budget: "The most a standing agent may do in one day. A safety net with the defaults filled in; it sits behind the role's settings, and a role that reaches it waits for tomorrow.",
