  ...
  return (
    <div data-cc-shell className={`bg-sol-bg flex flex-col overflow-hidden${s.clientState.ui?.simple_view ? " simple-view" : ""}`} style={{ height: zoomHeight }}>
      ...
      {/* Status notices (connection, storage, CLI offline, tmux missing) render
          nothing here — they float as corner cards via useStatusToast so a
          status that flaps never shifts the layout. The onboarding strips
          below them still sit in the flow. */}
