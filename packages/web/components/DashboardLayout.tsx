...
function DashboardLayoutInner({ children, hideSidebar }: DashboardLayoutProps) {
  ...
  const s = useTrackedStore([
    ...
    s => s.clientState.ui?.simple_view !== false,
  ...
  if (PANE_EMBED) {
    return (
      <div data-cc-shell data-cc-embed className={`bg-sol-bg overflow-hidden${s.clientState.ui?.simple_view !== false ? " simple-view" : ""}`} style={{ height: zoomHeight }}>
  ...
  return (
    <div data-cc-shell className={`bg-sol-bg flex flex-col overflow-hidden${s.clientState.ui?.simple_view !== false ? " simple-view" : ""}`} style={{ height: zoomHeight }}>
      <ErrorBoundary name="DashboardSync" level="inline" fallback={null}>
        <DashboardSyncEffects />
      </ErrorBoundary>
