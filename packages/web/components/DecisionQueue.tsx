...
function DecisionCard({
  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      <div
        className={`absolute left-0 right-0 bottom-0 flex flex-col bg-sol-bg border-t border-sol-border shadow-[0_-8px_24px_rgba(0,0,0,0.18)] transition-[height] duration-200 ease-out motion-reduce:transition-none ${
