// Session identity surfaces (docs/architecture/session-characters.md): one
// import for every place a session or a role shows who it is.
export { SessionFace, roleRingStyle } from "./SessionFace";
