...
import { Globe, Workflow, Zap, MessageSquare, FolderKanban, Layers, Users, UserMinus, Hash, MoreHorizontal, Pin, PinOff, BellOff, Blocks, Lock } from "lucide-react";
...
const ChatNavRow = memo(function ChatNavRow({
  ...
  const suggestedItems = suggestedDmMembers(
    ...
    onSelect: () => {
      ...
      const channelId = state.openDmChannel([String(m._id)], teamId ? String(teamId) : undefined);
