...
/** Below this the stage renders the focused pane only (the layout survives
 *  for a wider window). Matches lib/stage.openBeside's gate. */
...
export const StageSplitView = memo(function StageSplitView({
  tab,
  layout,
  isTabActive,
}: {
