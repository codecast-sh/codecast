...
const ITEM = cn(
  "text-[13px] leading-none rounded-lg px-2.5 py-2 gap-2.5",
  "text-sol-text-secondary focus:bg-sol-cyan/10 focus:text-sol-text",
  "[&>svg]:size-3.5 [&>svg]:text-sol-text-dim focus:[&>svg]:text-sol-cyan",
);

const DANGER = cn(
  "text-sol-red/90 focus:bg-sol-red/10 focus:text-sol-red",
  "[&>svg]:text-sol-red/70 focus:[&>svg]:text-sol-red",
);
