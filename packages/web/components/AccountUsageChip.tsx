        ...
        {g.entries.map((e, i) => (
          ...
          >
            <div className="mb-1 flex items-center gap-1.5">
              ...
              />
              {e.provider === "claude" ? (
                <span title="Claude" className="shrink-0 text-sol-text">
                  <ClaudeIcon className="h-3 w-3" />
                </span>
              ) : (
                <span title="Codex" className="shrink-0 text-sol-text">
    ...
    <div className="relative hidden md:block" onMouseEnter={openNow} onMouseLeave={closeSoon}>
      ...
      >
        {shown === "claude" ? (
          ...
          <ProviderSegment
            icon={<KeyRound className="h-3 w-3 shrink-0" style={{ color: codexTone }} />}
            label={codexLabel}
            percent={codexWorst}
            tone={codexTone}
            stub={false}
