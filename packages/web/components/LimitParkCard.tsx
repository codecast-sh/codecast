...
export function LimitParkCard({
  ...
  if (!live) {
    ...
    next = "The window is open again but nothing resumed the session — continue it to pick up where it left off.";
  } else if (!device) {
    next = "Parked until the window resets — send a message after that to pick up where it left off.";
    ...
    next = "Auto-switch is on — codecast hops to the freshest saved account and continues this session on its own.";
    ...
    next = "Auto-resume is off for this machine — it stays parked until you continue it.";
  }
