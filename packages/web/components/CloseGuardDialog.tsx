...
// Wire the shared task-action error reporter to sonner on the web (this module
// is web-only; the shared taskActions can't import a toast lib because mobile
// imports it too). Runs once at module load.
setTaskErrorReporter((msg) => toast.error(msg));
