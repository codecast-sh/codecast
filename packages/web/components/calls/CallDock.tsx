...
import { CallSurfaceRoot } from "./CallSurfaceRoot";
import { surfaceShape, useSurfaceHandles } from "../../lib/calls/surfaceHandles";
...
export function CallDock() {
  ...
  // you raise the huddle window from here.
  if (surface !== "walkie" && canPopOutCall()) return null;
