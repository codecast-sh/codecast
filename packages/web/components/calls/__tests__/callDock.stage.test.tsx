...
// The stage itself is a marker: the gate is under test, not the stage. Not a
// spread of the real module: loading the stage pulls the terminal in, which
// reads the navigator at load and dies under another file's globals.
