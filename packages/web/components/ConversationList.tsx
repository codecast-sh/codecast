          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs flex-wrap text-sol-text-dim select-none overflow-hidden">
              ...
              {(conv as any).active_plan && (
                <span className="inline-block align-middle px-1.5 py-0.5 rounded bg-sol-cyan/10 text-sol-cyan border border-sol-cyan/20 text-[10px] font-medium max-w-[120px] truncate" title={(conv as any).active_plan.title}>
