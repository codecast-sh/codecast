...
export function TriageBar() {
  ...
  return (
    <div
      data-triage-bar
      className="flex-shrink-0 h-8 pl-1.5 pr-2 border-t border-sol-border/30 bg-sol-bg-alt/30 flex items-center gap-0.5 text-[10px] text-sol-text-dim select-none"
    >
      {PARK_VERBS.map((v) => (
          ...
          <span className="hidden lg:flex items-center gap-2.5 text-sol-text-dim">
            <span className="flex items-center gap-1">
              <span className="flex items-center gap-[2px]">
                <KeyCap size="xs">{"⌃"}</KeyCap><KeyCap size="xs">J</KeyCap>
