...
export function PRRail({
  ...
  return (
    <div className="h-full overflow-y-auto">
      {empty && (
        <div className="px-4 py-6 text-[12px] text-sol-text-dim leading-relaxed">
          Nothing is linked to this pull request yet. Sessions that touch it, the tasks it closes and
          the people asked to review it appear here.
        </div>
      )}
      {ordered.length > 0 && (
