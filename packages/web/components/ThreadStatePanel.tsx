        ...
        >
          ...
          {!collapsed && (
            <div className="px-3 pb-2.5 -mt-0.5">
              <div className="text-[13px] text-sol-text-secondary leading-relaxed whitespace-pre-line break-words max-h-44 overflow-y-auto">
                <FormattedSummary text={view.text} />
              </div>
            </div>
          )}
        </div>
