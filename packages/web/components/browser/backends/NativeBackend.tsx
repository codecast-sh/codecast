  ...
  useWatchEffect(() => {
    ...
    void live
      .send("create", {
        ...
        // drive this view from `cast browser`. BrowserPane already confirmed
        // it against the store's offer row (paneOfferOwner) and stripped any
        // `s=` a pasted link named without an offer behind it.
