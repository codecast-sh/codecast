...
import {
  browserPaneBridge,
  nativeBrowserPaneAvailable,
  subscribeNativeBrowserPane,
...
/** Does this build have the native view? The bridge existing proves nothing —
 *  every desktop build carries the generic IPC call — so the answer is the
 *  shell's own capability reply, and this re-renders when it lands. */
