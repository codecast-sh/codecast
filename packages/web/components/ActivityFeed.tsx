...
const NO_GIT_EVENTS: GitEventRow[] = [];
...
function FeedBody({ source, sourceConvs, gitEvents = NO_GIT_EVENTS, hasMore, loadMore, isLoading, isLoadingMore, onNavigate, compact, hidePeopleRow, initialActorId, shareNudge }: {
  ...
  const gitInView = useMemo(() => {
    if (gitEvents.length === 0) return NO_GIT_EVENTS;
    let floor = 0;
