...
/** The shortest hold the engine will keep, from lib/calls/walkie.ts. Mirrored
 *  here for the invariant test rather than imported, because that module drags
 *  LiveKit in and this one is pure. */
export const WALL_BURST_FLOOR_MS = 700;
