...
export function LabelChipsRow({
  ...
  return (
    // No min-w-0 on this row, deliberately: its automatic minimum size is then
    // its min-content width, which — with the clip shell free to collapse — is
    // the +N pill's width. That is what reserves room for the pill however
    // narrow the panel gets (a zoomed-in window squeezes the header hard).
    <div ref={anchorRef} className="relative flex-1 flex items-center gap-1">
