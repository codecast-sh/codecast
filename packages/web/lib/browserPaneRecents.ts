...
// newest first, written by the gesture funnel every pane opens through
// (openBrowserPane in lib/stage.ts) and by the address bar when a person types
// a page, and read by the blank pane's empty state.
//
