...
/** The app this document IS: the window was opened as Chat or Work. Null in
 *  the main window, a plain breakout, a browser. Fixed for the document's
 *  life, like the detached-window flag it rides beside. */
export function desktopAppWindow(): DesktopApp | null {
  if (typeof window === "undefined") return null;
  const app = window.__CODECAST_ELECTRON__?.appWindow;
