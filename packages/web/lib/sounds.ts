...
export function soundCallRing() {
  ...
  // (assets/sounds/huddle-ring.m4a): a friendly knock (G#5→E5), then a
  // brighter answer (B5→E6), over a soft low E. Each strike carries a quiet
  // octave partial for the struck-bell timbre.
  play([
