...
/** A paragraph that is exactly one embed renders the embed at block level;
 *  an embed mixed into prose stays inline (degrades to an ordinary wiki link
 *  in the renderer). Same semantics as remarkEntityIds.hoistEmbeds. */
