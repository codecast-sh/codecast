...
import { buildCanvasShell } from '@/lib/canvasShell';
...
export function CastCanvas({ code }: { code: string }) {
  ...
  const shell = useMemo(() => (fullscreen ? buildCanvasShell(code, solTokensCss(), CONVEX_ORIGIN) : null), [fullscreen, code, scheme]);
