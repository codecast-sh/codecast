...
struct AgentMark {
    ...
    init(agent: String) {
        switch agent {
        case "claude": self = .init(letters: "cl", tint: Palette.orange)
        case "codex": self = .init(letters: "cx", tint: Palette.green)
        case "grok": self = .init(letters: "gk", tint: Palette.blue)
        case "opencode": self = .init(letters: "oc", tint: Palette.violet)
