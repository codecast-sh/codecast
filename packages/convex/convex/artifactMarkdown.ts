 ...
 * Grotesk for reading text, JetBrains Mono for anything that is code or a label. The
 * @import has to be the first rule of whichever <style> holds this. */
export const MD_THEME_CSS = `
@import url("https://fonts.googleapis.com/css2?family=Hanken+Grotesk:ital,wght@0,400..700;1,400..700&family=JetBrains+Mono:wght@400;500;600&display=swap");
:root {
...
.md {
  font: 400 clamp(16px, 1rem + .1vw, 17px)/1.65 "Hanken Grotesk", "Helvetica Neue", Helvetica, Arial, sans-serif;
  color: var(--md-ink);
...
.md h1, .md h2, .md h3, .md h4, .md h5, .md h6 {
  position: relative; font-weight: 600; line-height: 1.2; color: var(--md-ink);
  letter-spacing: -.015em; text-wrap: balance; scroll-margin-top: 64px;
}
.md h1 { font-size: 2.15em; font-weight: 700; margin: 0 0 .6em; letter-spacing: -.028em; line-height: 1.1; }
.md h2 { font-size: 1.45em; margin: 1.8em 0 .55em; padding-top: .7em; border-top: 1px solid var(--md-line); }
.md h1 + h2 { border-top: 0; padding-top: 0; margin-top: 1.2em; }
.md h3 { font-size: 1.18em; margin: 1.6em 0 .45em; }
.md h4 { font-size: 1.02em; font-weight: 600; margin: 1.5em 0 .4em; }
...
.md code, .md kbd, .md samp { font-family: "JetBrains Mono", ui-monospace, SFMono-Regular, Menlo, monospace; font-size: .86em; }
...
.md table { border-collapse: collapse; width: 100%; font-size: .94em; line-height: 1.45; font-variant-numeric: tabular-nums lining-nums; }
...
<style>${MD_THEME_CSS}
  * { box-sizing: border-box; }
  ...
  @media (max-width: 640px) { .md .anchor { display: none; } .md h1 { font-size: 1.85em; } }
  @media print {
