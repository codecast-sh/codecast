...
import { escHtml, escAttr } from "./artifactPages";
...
.md :not(pre) > code { background: var(--md-soft); padding: .12em .38em; border-radius: 4px; color: var(--md-ink); }
...
.md pre[data-lang]::before { content: attr(data-lang); position: absolute; top: 8px; right: 12px; color: var(--md-dim);
...
.md input[type=checkbox] { accent-color: var(--md-coral); width: 1em; height: 1em; margin: 0; position: relative; top: .1em; flex: none; }
