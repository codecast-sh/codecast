...
import { PROMPT_CACHE_LIFETIME_MS, formatIdle, restartPlan, restartReloadsContext, wakeCost, wakeFieldsOf } from "./wakeCost";
...
describe("restartPlan — what the restart bar ticks and what it costs", () => {
  const row = (id: string, parkedMinAgo: number, ctx: number) => ({
