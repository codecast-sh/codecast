...
// The window and the wording live in the shared contracts, so the fold-up the
// phone shows and the one the web bell renders are the same fold-up.
export { IDLE_DIGEST_WINDOW_MS, summarizeIdleDigest };
