 ...
 *    these.
 *
 *  Muted subscriptions grant nothing. Shared by the live touch in tasks.ts,
 *  the backfill above and the inbox resolver's defense in threads.ts. */
