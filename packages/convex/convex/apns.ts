...
export async function mintApnsJwt(keyId: string, teamId: string, pem: string): Promise<string> {
...
export async function sendApns(args: ApnsSendArgs): Promise<ApnsSendResult> {
