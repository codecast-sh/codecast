...
export function seatTitlePatch(adopt: any, roleName: string): Record<string, any> {
  if (adopt.title === roleName && adopt.title_is_custom) return {};
  return { title: roleName, title_is_custom: true, seat_previous: { title: adopt.title ?? undefined, title_is_custom: adopt.title_is_custom ?? undefined } };
}
