...
<style id="__cc_style">
  ...
  /* Composer: draft cards + ghost add-buttons + identity line + actions. */
  #__cc_cpanel .__cc_draft { margin: 0 0 8px; padding: 8px 9px 9px; border: 1px solid var(--cc-line); border-radius: 10px;
    background: var(--cc-soft); }
  #__cc_cpanel .__cc_draft .__cc_dtop { margin-bottom: 6px; }
  #__cc_cpanel .__cc_dlabel { color: var(--cc-dim); font-size: 10px; font-weight: 600; letter-spacing: .07em; text-transform: uppercase; }
  #__cc_cpanel .__cc_ta { background: var(--cc-card); }
  #__cc_cpanel .__cc_addrow { display: flex; gap: 6px; padding: 0 0 2px; }
  #__cc_cpanel .__cc_addrow .__cc_btn { display: inline-flex; align-items: center; gap: 6px; background: none;
    border: 1px solid var(--cc-line); border-radius: 8px; padding: 6px 10px; color: var(--cc-mut); font-size: 11px; }
  #__cc_cpanel .__cc_addrow .__cc_btn:hover { border-color: var(--cc-inbd); color: var(--cc-ink); background: var(--cc-hov); filter: none; }
  ...
  #__cc_cpanel .__cc_pendrow { margin: 8px 0 0; padding: 7px 10px; border: 1px dashed var(--cc-inbd); border-radius: 9px; }
  ...
  #__cc_cpanel .__cc_rwrap { margin: 8px 0 2px 24px; padding: 8px 9px 9px; border: 1px solid var(--cc-line); border-radius: 10px;
    background: var(--cc-soft); }
