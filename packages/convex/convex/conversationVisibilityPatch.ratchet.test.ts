...
//
// Nothing is pinned: the last two bypasses (the team_id backfills in
// conversations.ts) now call the chokepoint, so the next one fails in this
// test rather than in a privacy report.
