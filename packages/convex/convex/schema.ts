...
export default defineSchema({
  ...
  devices: defineTable({
    ...
    // the stacks it was in. This is the loop-freeze SLO the daemonLogs cron
    ...
    // Dedupe/cooldown state for the aggregated "daemon overloaded" notification
  ...
  notifications: defineTable({
    ...
    type: v.union(
      ...
      v.literal("chat_post"),
      // One machine's daemon event loop froze past the SLO in the last hour
