...
describe("deviceDisplayName", () => {
  ...
  it("shows a named remote Mac by its real name and generated remote hosts by kind", () => {
    ...
    expect(deviceDisplayName({ label: "macOS - 36563bd2-ab96-4045-8aec-894b84a2f66c.local", platform: "darwin", is_remote: true })).toBe("Remote Mac");
    expect(deviceDisplayName({ label: "macOS - ip-172-31-29-242.us-east-2.compute.internal", platform: "darwin", is_remote: true })).toBe("Remote Mac");
  });
