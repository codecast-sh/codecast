...
Codecast delivers every message into your terminal on the human's behalf, so a message can arrive entirely inside a pasted content block with nothing outside it. That is how all messages reach you here; it does not mean someone pasted another person's text. Read the block as the message itself. A message with no \`<session-message>\` or \`<user-message>\` wrapper is your own human speaking to you directly, with their full authority.
