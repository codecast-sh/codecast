...
export const TOOL_VISUALS: Record<string, ToolVisual> = {
  ...
  "Web search:": { icon: "globe", color: "violet" },
  x_user_search: { icon: "globe", color: "violet" },
  x_semantic_search: { icon: "globe", color: "violet" },
  x_keyword_search: { icon: "globe", color: "violet" },
  search_tool: { icon: "search", color: "violet" },
  open_page_with_find: { icon: "search", color: "violet" },

  WebFetch: { icon: "globe", color: "cyan" },
  web_fetch: { icon: "globe", color: "cyan" },
  webfetch: { icon: "globe", color: "cyan" },
  open_page: { icon: "globe", color: "cyan" },
  x_thread_fetch: { icon: "globe", color: "cyan" },
  ...
  image_edit: { icon: "desktop", color: "magenta" },
  image_to_video: { icon: "desktop", color: "magenta" },
  reference_to_video: { icon: "desktop", color: "magenta" },
  scheduler_create: { icon: "bolt", color: "violet" },
  scheduler_delete: { icon: "bolt", color: "violet" },
  scheduler_list: { icon: "bolt", color: "violet" },
  monitor: { icon: "bolt", color: "cyan" },
  workflow: { icon: "cog", color: "cyan" },
  use_tool: { icon: "plug", color: "cyan" },
  enter_plan_mode: { icon: "map-o", color: "violet" },
  exit_plan_mode: { icon: "map-o", color: "violet" },
  ask_user_question: { icon: "question-circle-o", color: "blue" },
