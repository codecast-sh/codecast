...
// only lints packages/web, `typecheck` runs web + convex strictly AND gates
// cli's added lines (scripts/ci/changed-lines-gate.ts, ct-49564), and every
// package test reads @codecast/shared.
export const JOB_AREAS: Record<string, Area[]> = {
  build: ["cli", "web", "shared", "extension"],
  typecheck: ["web", "convex", "shared", "cli"],
  lint: ["web"],
