...
advancing custody. That work and rebuilt packaging checks remain unfinished in
the checkpoint; E1/E2 and F1/F2 local acceptance do not imply F3 acceptance.
...
path and boot token. It is not daemon boot time.
